        ...
        <div className="space-y-6">
          <div className={cardCls}>
            ...
            <form onSubmit={handleUpdate} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={saving}
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-primary px-4 py-3 text-sm font-semibold text-white transition hover:bg-primary-dark disabled:opacity-70 dark:bg-white dark:text-zinc-900 dark:hover:bg-zinc-200"
              >
          ...
          <div className={cardCls}>
            ...
            {order.shipment?.consignmentId ? (
              ...
              <div className="space-y-3">
                ...
                >
                  {creatingShipment ? <Spinner size={15} /> : <FiTruck size={15} />} {creatingShipment ? 'Creating...' : 'Create Shipment'}
                </button>
              </div>
            )}
          </div>
          ...
          <div className={cardCls}>
            ...
            <div className="flex gap-2">
              ...
              >
                {downloadingInvoice ? <Spinner size={15} /> : <FiDownload size={15} />} {downloadingInvoice ? 'Preparing...' : 'Download PDF'}
              </button>
              <button
                type="button"
                onClick={sendInvoice}
              ...
              >
                {sendingInvoice ? <Spinner size={15} /> : <FiSend size={15} />} {sendingInvoice ? 'Sending...' : 'Send Invoice'}
              </button>
            </div>
            {order.invoiceSentAt && (
